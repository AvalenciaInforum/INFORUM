Public Class frmNuevaCompania
    Private Sub frmNuevaCompania_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            For iCont As Integer = 0 To SAPCore.MainDatasets.dspCompania.Tables(0).Rows.Count - 1
                iCompaniaAsignada = SAPCore.HANAConnections.HANAExecuteScalar(oHANADataBase, "Select count(*) from INF_CONSOLIDADOR.ESTR_COMP where ""COMPANIA"" = '" & SAPCore.MainDatasets.dspCompania.Tables(0).Rows.Item(iCont).Item(6) & "'")
            ...
            dtPADRES = SAPCore.HANAConnections.HANAExecuteReader(oHANADataBase, "Select ""COMPANIA"" from INF_CONSOLIDADOR.ESTR_COMP")
    ...
    Private Sub btnGrabar_Click(sender As Object, e As EventArgs) Handles btnGrabar.Click
        ...
        Try
            ...
            'MsgBox(SAPCore.HANAConnections.HANAExecuteScalar(oHANADataBase, "Select Ifnull(Sum(""PORCENTAJE""),0) from INF_CONSOLIDADOR.ESTR_COMP where ""PADRE"" = '" & cbPADRE.SelectedValue.ToString.Trim & "'"))
            If Convert.ToInt32(SAPCore.HANAConnections.HANAExecuteScalar(oHANADataBase, "Select Ifnull(Sum(""PORCENTAJE""),0) from INF_CONSOLIDADOR.ESTR_COMP where ""PADRE"" = '" & cbPADRE.SelectedValue.ToString.Trim & "'")) + Convert.ToInt32(txtPorcentaje.Text) <= 100 Then
                ...
                sQuery = "Insert into INF_CONSOLIDADOR.CUEXCOMP Select '" & oHANADataBaseRead.DataBase & "' COMPANIA , Ifnull(OACT.""FormatCode"", OACT.""AcctCode"") Cuenta, OACT.""AcctName"" Nombre, OACT.""GroupMask"" Cajon, OACT.""Levels"" Nivel, '','','', 0 from " & oHANADataBaseRead.DataBase & ".OACT Where OACT.""Levels"" >= 4 order by Ifnull(OACT.""FormatCode"", OACT.""AcctCode"")"

                SAPCore.HANAConnections.HANAExecuteNonQuery(oHANADataBaseRead, sQuery)
