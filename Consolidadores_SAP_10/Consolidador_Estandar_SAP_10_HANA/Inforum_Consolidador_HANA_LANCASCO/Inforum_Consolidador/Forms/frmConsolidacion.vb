            ...
            For iContRow As Integer = 0 To dtESTR.Rows.Count - 1
                Try
                    ...
                    For iContSucursal As Integer = 0 To SAPCore.MainDatasets.dspCompania.Tables(0).Rows.Count - 1
                        If SAPCore.MainDatasets.dspCompania.Tables(0).Rows.Item(iContRead).Item(6) = oHANADataBaseRead.DataBase Then
                    ...
                    Else
                        If oCompany.Connected() Then
                            ...
                            sQuery = sQuery.Replace("DATABASE", oHANADataBaseRead.DataBase)
                            sQuery = sQuery.Replace("FECHAINICIAL", sFecha_Inicial)
                            sQuery = sQuery.Replace("FECHAFINAL", sFecha_Final)

                            dtBRANCHES = SAPCore.HANAConnections.HANAExecuteReader(oHANADataBaseRead, sQuery)
                            ...
                            For iContBranch As Integer = 0 To dtBRANCHES.Rows.Count - 1
                                ...
                                dtASIENTO = SAPCore.HANAConnections.HANAExecuteReader(oHANADataBaseRead, sQuery)
                                ...
                                oAsiento.Reference = "Branch " & oHANADataBaseRead.DataBase & " del " & oDTP1.Value.Date & " al : " & oDTP2.Value.Date
                                ...
                                For iContAC As Integer = 0 To dtASIENTO.Rows.Count - 1
                                    ...
                                    'MsgBox(Busca_Cuenta(oHANADataBaseRead.DataBase, oCompany.CompanyDB, dtASIENTO.Rows.Item(iContAC)("AccountCode")) & " " & dtASIENTO.Rows.Item(iContAC)("AccountCode"))

                                    sCuenta = Busca_Cuenta(oHANADataBaseRead.DataBase, oCompany.CompanyDB, dtASIENTO.Rows.Item(iContAC)("ACCOUNTCODE"))
                                ...
                                'MsgBox(oHANADataBaseRead.DataBase & " " & dCredit.ToString & " " & dDebit.ToString)
                                ...
                                If iRetVal <> 0 Then
                                    ...
                                    sErrorMSG &= " | " & oHANADataBaseRead.DataBase & " : Sucursal: " & dtBRANCHES.Rows.Item(iContBranch)("BRANCH") & " : " & iError.ToString & " - " & sError
                                ...
                                Else
                                    sCorrectoMSG &= " | " & oHANADataBaseRead.DataBase & " : Sucursal: " & dtBRANCHES.Rows.Item(iContBranch)("BRANCH") & " : " & "Asiento contable generado correctamente"
