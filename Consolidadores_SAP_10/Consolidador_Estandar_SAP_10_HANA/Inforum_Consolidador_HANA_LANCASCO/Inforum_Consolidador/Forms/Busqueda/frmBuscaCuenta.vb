Public Class frmBuscaCuenta
    ...
    Private Sub frmBuscaCuenta_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Function BuscaCuenta() As Integer
        ...
        Try
            sQuery = "Select Ifnull(OACT.""FormatCode"", OACT.""AcctCode"") Cuenta, OACT.""AcctName"" Nombre, OACT.""GroupMask"" Cajon, OACT.""Levels"" Nivel from " & oHANADataBaseRead.DataBase & ".OACT Where OACT.""Levels"" >= 4 "
            ...
            dtCuentas = SAPCore.HANAConnections.HANAExecuteReader(oHANADataBaseRead, sQuery)
    ...
    Private Sub frmBuscaCuenta_FormClosing(sender As System.Object, e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        Try
            bVieneDeBuscaCuenta = True
        Catch ex As Exception
            System.Windows.Forms.MessageBox.Show(ex.Message, "Error interno", MessageBoxButtons.OK, MessageBoxIcon.Error)
