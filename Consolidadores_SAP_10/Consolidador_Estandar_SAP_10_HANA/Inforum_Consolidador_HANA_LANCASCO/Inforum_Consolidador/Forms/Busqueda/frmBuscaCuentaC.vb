Public Class frmBuscaCuentaC
    ...
    Private Function BuscaCuenta() As Integer
        ...
        Try
            sQuery = "Select Ifnull(OACT.""FormatCode"", OACT.""AcctCode"") Cuenta, OACT.""AcctName"" Nombre, OACT.""GroupMask"" Cajon, OACT.""Levels"" Nivel from " & oHANADataBaseRead.DataBase & ".OACT Where OACT.""Levels"" >= 4 and Ifnull(OACT.""FormatCode"", OACT.""AcctCode"") not in (Select ""CUENTA_CODIGO"" from INF_CONSOLIDADOR.CUEXCOMP Where ""COMPANIA"" = '" & oHANADataBaseRead.DataBase & "')"
