Public Class frmLogin
    ...
    Private Sub Login_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            iContEstr = SAPCore.SQLConnections.SQLExecuteScalar(oSQlDataBase, sQuery)
            ...
            If iContEstr = 0 Then
                ...
                Else
                    ...
                    If Not oRecordSet.EoF Then
                        SAPCore.SQLConnections.SQLExecuteNonQuery(oSQlDataBase, "Insert into INF_CONSOLIDADOR.ESTR_COMP Values ('" & oCompany.CompanyDB & "','" & oRecordSet.Fields.Item(0).Value.ToString & "','SELF','C',0,100)")
                    End If
                End If
