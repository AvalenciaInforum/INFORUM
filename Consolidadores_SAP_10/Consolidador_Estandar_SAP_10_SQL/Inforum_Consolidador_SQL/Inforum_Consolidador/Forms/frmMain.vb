...
Public Class frmMain
    ...
    Private Sub frmMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            'Valida si no hay por lo menos una base de datos SQL configurada
            If SAPCore.MainDatasets.dspHANA.Tables(0).Rows.Item(0).Item(0) = "" Then
                Dim frmSQL As New SAPCore.frmSQLConnectionDataM
                frmSQL.TopMost = True
                frmSQL.FormBorderStyle = Windows.Forms.FormBorderStyle.FixedSingle
            ...
            oSQlDataBase = New SAPCore.SQLDataBase
            oSQlDataBase = SAPCore.SQLDataBase.Load(SAPCore.MainDatasets.dspHANA.Tables(0).Rows.Item(0))
    ...
    Private Sub ConexiónSQLToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ConexiónSQLToolStripMenuItem.Click
        Dim frmSQL As New SAPCore.frmSQLConnectionDataM
