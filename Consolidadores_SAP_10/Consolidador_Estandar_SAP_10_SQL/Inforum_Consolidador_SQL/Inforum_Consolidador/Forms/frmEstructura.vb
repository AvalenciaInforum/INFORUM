Public Class frmEstructura
    ...
    Private Sub frmEstructura_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            dtESTR_COMP = SAPCore.SQLConnections.SQLExecuteReader(oSQlDataBase, "Select * from INF_CONSOLIDADOR.ESTR_COMP")
    ...
    Private Sub ShowNodeData(ByVal nod As TreeNode)
        ...
        Try
            ...
            'oSQlDataBaseRead = New SAPCore.HANADataBase
            ...
            'oSQlDataBaseRead = New SAPCore.HANADataBase
            'oSQlDataBaseRead = SAPCore.HANADataBase.Load(SAPCore.MainDatasets.dspHANA.Tables(0).Rows.Item(0))


            'dtSAPCuentas = SAPCore.HANAConnections.HANAExecuteReader(oSQlDataBaseRead, "Select IsNull(OACT.FormatCode, OACT.AcctCode) Cuenta, OACT.AcctName Nombre, OACT.GroupMask Cajon, OACT.Levels Nivel from OACT Where OACT.Levels >= 5 order by IsNull(OACT.FormatCode, OACT.AcctCode)")

            dtSAPCuentas = SAPCore.SQLConnections.SQLExecuteReader(oSQlDataBase, "Select ""CUENTA_CODIGO"" oCol01, ""CUENTA_NOMBRE"" oCol02, ""CAJON"" oCol03, ""NIVEL"" oCol04, ""CUENTA_CODIGO2"" oCol05, ""CUENTA_NOMBRE2"" oCol06, ""CAJON2"" oCol07, ""NIVEL2"" oCol08 from INF_CONSOLIDADOR.CUEXCOMP where ""COMPANIA"" = '" & r("COMPANIA").ToString() & "' order by ""COMPANIA"", ""CUENTA_CODIGO""")
    ...
    Private Sub btnActualizar_Click(sender As Object, e As EventArgs) Handles btnActualizar.Click
        ...
        Try
            ...
            SAPCore.SQLConnections.SQLExecuteNonQuery(oSQlDataBase, "Update INF_CONSOLIDADOR.ESTR_COMP Set ""PADRE"" = '" & cbCompany.SelectedValue.ToString.Trim & "', ""PORCENTAJE"" = " & txtPorcentaje.Text.Trim & " where ""COMPANIA"" = '" & r("COMPANIA").ToString() & "'")
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        ...
        Try
            ...
            If iRespuesta = 6 Then
                ...
                sQuery &= "     inner join "
                sQuery &= "     " & oSQlDataBaseRead.DataBase & ".OACT "
    ...
    Private Sub oDGV01_RowLeave(sender As Object, e As DataGridViewCellEventArgs) Handles oDGV01.RowLeave
        ...
        Try
            If oDGV01.Rows.Item(e.RowIndex).Cells.Item(0).Value.ToString <> "" And oDGV01.Rows.Item(e.RowIndex).Cells.Item(4).Value.ToString <> "" Then
                ...
                iContEncuentra = SAPCore.SQLConnections.SQLExecuteScalar(oSQlDataBase, sQuery)
